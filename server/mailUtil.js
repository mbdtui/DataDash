  ...
  switch(jsonObject.table){
    case 'c_driver_schedule':
      if(jsonObject.function_called == 'update_schedule_starttime_by_runname_auditid'){
        paramString = "c_driver_schedule: Update schedule start time by run name and auditID.  MacroID: " + jsonObject.macroID + " with the following parameters: run name: " +
        ...
        paramString = "c_driver_schedule: Update status code by run name and auditID.  MacroID: " + jsonObject.macroID + " with the following parameters: run name: " +
        ...
        paramString = "c_driver_schedule: Update valuation start date by run name and auditID.  MacroID: " + jsonObject.macroID + " with the following parameters: run name: " +
        ...
        paramString = "c_driver_schedule: Update sla date and time by auditID.  MacroID: " + jsonObject.macroID + " with the following parameters: auditID: " +
        ...
        paramString = "c_driver_schedule: Update sla date and time by run name.  MacroID: " + jsonObject.macroID + " with the following parameters: run name: " +
        ...
        paramString = "c_driver_schedule: Update historical sla date and time by run name.  MacroID: " + jsonObject.macroID + " with the following parameters: run name: " +
        jsonObject.params.run_name + ", date: " + jsonObject.params.date + ", time:" + jsonObject.params.time;
      }//run_name, date, time
      else if(jsonObject.function_called == 'delete_all_entries_by_runname'){
        paramString = "c_driver_schedule: Delete all entries by runname.  MacroID: " + jsonObject.macroID + " with the following parameters: run name: " + jsonObject.params.run_name;
      }
      else{
    ...
    case 'c_driver_step':
      if(jsonObject.function_called == 'delete_all_entries_by_runname'){
        paramString = "c_driver_step: Delete all entries by runname.  MacroID: " + jsonObject.macroID + " with the following parameters: run name: " + jsonObject.params.run_name;
      }
      else if(jsonObject.function_called == 'delete_all_entries_by_runname_groupnumber'){
        paramString = "c_driver_step: Delete all entries by runname and group number.  MacroID: " + jsonObject.macroID + " with the following parameters: run name: " + jsonObject.params.run_name +
      ", group number: " + jsonObject.params.group_number;
        ...
        paramString = "c_driver_step: Delete all entries by runname and driver step id.  MacroID: " + jsonObject.macroID + " with the following parameters: run name: " + jsonObject.params.run_name +
      ", driver step ID: " + jsonObject.params.driver_step_id;
        ...
        paramString = "c_driver_step: Update active step indicator by driver step ID.  MacroID: " + jsonObject.macroID + " with the following parameters: driver step ID: " +
        ...
        paramString = "c_driver_step: Update active step indicator by run name and driver step ID.  MacroID: " + jsonObject.macroID + " with the following parameters: run name: " +
        ...
        paramString = "c_driver_step: Update active step indicator by run name.  MacroID: " + jsonObject.macroID + " with the following parameters: run name: " +
        ...
        paramString = "c_driver_step: Update active step indicator by run name and group number.  MacroID: " + jsonObject.macroID + " with the following parameters: run name: " +
    ...
    case 'c_driver_step_detail':
      if(jsonObject.function_called == 'delete_all_entries_by_runname'){
        paramString = "c_driver_step_detail: Delete all entries by runname.  MacroID: " + jsonObject.macroID + " with the following parameters: run name: " + jsonObject.params.run_name;
      }//run_name
      else if(jsonObject.function_called == 'update_run_status_code_by_runname_groupnumber'){
        paramString = "c_driver_step_detail: Update run status code by run name and group number.  MacroID: " + jsonObject.macroID + " with the following parameters: run name: " +
        ...
        paramString = "c_driver_step_detail: Update run status code by run name and driver step detail ID.  MacroID: " + jsonObject.macroID + " with the following parameters: run name: " +
